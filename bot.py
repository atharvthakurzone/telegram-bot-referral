    ...
    # Admin options
        ...
        commands_pages = [
            (
                ...
                "/dm <user_id> <message> – Send custom message to a user"
            ),
            (
                "📊 *Reports & Tracking*\n\n"
                "/last10 – Show last 10 registered users\n"
                "/pending – View pending activations\n"
                "/active – Show list/count of active users\n"
                "/inactive – Show list/count of inactive users"
            ),
            (
                "📢 *Communication*\n\n"
                "/notify <message> – Send notification to all activated users\n"
                "/remind – Send payment reminder to all inactive users"
            )
        ]
